...
- [DEReD](https://github.com/Ehzoahis/DEReD): For specific methods used in self-supervised depth estimation from defocus clues and part of the inspiration for this work.
